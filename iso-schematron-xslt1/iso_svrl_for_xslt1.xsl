...
<xsl:stylesheet
  ...
  <!-- Select the import statement and adjust the path as necessary for your system.
  ...
  <xsl:template name="process-root">
    ...
    <svrl:schematron-output title="{$title}" schemaVersion="{$schemaVersion}" >
      ...
      <!-- VJ : à claquer dans une autre XSLT de surcharge ? -->
      <svrl:file><axsl:value-of select="$fileNameParameter"/></svrl:file><!-- élément OBVIL pour conserver le nom du fichier validé -->
